...
namespace lazye::OpenGLUniformHelper
{
    ...
    inline void SetUniform(GLint location, Vector2f& v) { glUniform2fv(location, 1, v.GetDataPtr()); }
    inline void SetUniform(GLint location, Vector3f& v) { glUniform3fv(location, 1, v.GetDataPtr()); }
    inline void SetUniform(GLint location, Vector4f& v) { glUniform4fv(location, 1, v.GetDataPtr()); }
    ...
    inline void SetUniform(GLint location, Vector2ui& v) { glUniform2uiv(location, 1, v.GetDataPtr()); }
    inline void SetUniform(GLint location, Vector3ui& v) { glUniform3uiv(location, 1, v.GetDataPtr()); }
    inline void SetUniform(GLint location, Vector4ui& v) { glUniform4uiv(location, 1, v.GetDataPtr()); }
    ...
    inline void SetUniform(GLint location, Vector2i& v) { glUniform2iv(location, 1, v.GetDataPtr()); }
    inline void SetUniform(GLint location, Vector3i& v) { glUniform3iv(location, 1, v.GetDataPtr()); }
    inline void SetUniform(GLint location, Vector4i& v) { glUniform4iv(location, 1, v.GetDataPtr()); }
}